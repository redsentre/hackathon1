      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden py-20 md:py-32">
          ...
          <div className="relative max-w-4xl mx-auto px-4 text-center">
            ...
            >
              <div className="px-4 py-2 rounded-full bg-navy-mid border border-white/10 text-sm">
                <span className="text-teal font-bold">27%</span> Financial Literacy in India
              </div>
              <div className="px-4 py-2 rounded-full bg-navy-mid border border-white/10 text-sm">
        ...
        <section className="max-w-4xl mx-auto px-4 py-16 border-t border-white/10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Paste or Upload</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">AI Detects</h3>
              <p className="text-sm text-muted">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">You Understand</h3>
              <p className="text-sm text-muted">
        ...
        <section className="bg-navy-mid/50 border-y border-white/10 py-12">
          <div className="max-w-4xl mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="flex items-center gap-3">
                <Globe className="w-5 h-5 text-teal flex-shrink-0" />
        ...
        <section className="max-w-4xl mx-auto px-4 py-16">
          <details className="group">
            ...
            <div className="mt-4 pt-4 border-t border-white/10 space-y-2 text-sm text-muted">
